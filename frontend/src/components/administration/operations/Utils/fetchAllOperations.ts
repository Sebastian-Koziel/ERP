...
export const fetchAllOperations = async (): Promise<Operation[] | FetchError> => {
    ...
    if(!response.ok) {
      ...
      const errorMessage = errorResponse.message || 'Something went wrong with fetching operations';
